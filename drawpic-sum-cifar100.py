...
data_path = root_path + '/results/sum-cifar100/'
...
plt.ylim(40,75)  ### 调整 y 轴坐标
plt.xlim(-2,104)  ### 调整 x 轴坐标
# plt.yticks([15,25,35,45,55,65,75])  ### 调整坐标轴刻度
ax=plt.gca()
